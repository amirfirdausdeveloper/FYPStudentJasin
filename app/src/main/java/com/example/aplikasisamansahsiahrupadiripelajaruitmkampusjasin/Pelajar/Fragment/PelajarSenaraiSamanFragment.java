...
import com.example.aplikasisamansahsiahrupadiripelajaruitmkampusjasin.Pelajar.Adapter.SenaraiSamanAdapter;
 ...
 */
public class PelajarSenaraiSamanFragment extends Fragment {
    ...
    private void getDetails(){
        ...
        mDatabaseSaman.orderByChild("studentID").equalTo(MainDashboardPelajar.student_id)
