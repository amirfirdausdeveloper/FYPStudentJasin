package com.example.aplikasisamansahsiahrupadiripelajaruitmkampusjasin.Pensyarah.Register;
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            PensyarahClass pensyarah = new PensyarahClass(
